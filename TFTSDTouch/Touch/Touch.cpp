...
parameter:
		chCoordType:
					...
					0 : relative position
*******************************************************************************/
uint8_t cTouch::Scan(uint8_t chCoordType)
{
...
*******************************************************************************/
void cTouch::ShowInfo(POINT Xpoint0, POINT Ypoint0,
...
*******************************************************************************/
void cTouch::Init( LCD_SCAN_DIR Lcd_ScanDir, Adafruit_SPITFT *mytft )
{
    tft = mytft;
    gpio_put(TP_CS_PIN,1);
//    gpio_put
